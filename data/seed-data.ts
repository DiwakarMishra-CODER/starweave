...
const artists: Artist[] = [
  ...
  { id: 'the-stooges', name: 'The Stooges', layer: 'root', genres: ['proto-punk'], scope: V1, country: 'US', activeFrom: 1967, signatureSong: 'I Wanna Be Your Dog',
    classicAlbums: [ca('the-stooges-st', 'The Stooges', 1969, "A primal, three-chord blast built around Ron Asheton's fuzz riffs and Iggy Pop's confrontational sneer, arriving fully formed before punk had a name for what it was. 'I Wanna Be Your Dog' reduces desire to a single sledgehammer riff and a sleigh-bell hook. VERIFY / rewrite.")] },
  { id: 'new-york-dolls', name: 'New York Dolls', layer: 'root', genres: ['proto-punk'], scope: V1, country: 'US', activeFrom: 1971, signatureSong: 'Personality Crisis',
    classicAlbums: [ca('new-york-dolls-st', 'New York Dolls', 1973, "Glam sleaze and Stones-derived swagger played sloppy and loud, with Johnny Thunders' guitar sound becoming a direct blueprint for punk guitarists who came after. 'Personality Crisis' piles on piano, cowbell, and a sneering David Johansen vocal until it nearly collapses under its own excess. VERIFY / rewrite.")] },
  { id: 'kraftwerk', name: 'Kraftwerk', layer: 'root', genres: ['krautrock'], scope: V1, country: 'DE', activeFrom: 1970, signatureSong: 'Trans-Europe Express',
    classicAlbums: [ca('trans-europe-express', 'Trans-Europe Express', 1977, "Kraftwerk built an entire electronic vocabulary from synthesizers and drum machines alone, imagining a gleaming, mechanized Europe as the album's organizing metaphor. The title track's motorik pulse became a foundational reference point for synth-pop, techno, and post-punk alike. VERIFY / rewrite.")] },
  { id: 'can', name: 'Can', layer: 'root', genres: ['krautrock'], scope: V1, country: 'DE', activeFrom: 1968, signatureSong: 'Halleluwah',
    classicAlbums: [ca('tago-mago', 'Tago Mago', 1971, "Can fused free-jazz improvisation, tape editing, and a relentless motorik pulse from drummer Jaki Liebezeit into something with no real precedent in rock music. 'Halleluwah' stretches an eighteen-minute groove into a hypnotic, almost trance-like exercise in repetition and variation. VERIFY / rewrite.")] },
  { id: 'neu', name: 'Neu!', layer: 'root', genres: ['krautrock'], scope: V1, country: 'DE', activeFrom: 1971, signatureSong: 'Hallogallo',
    classicAlbums: [ca('neu-st', 'Neu!', 1972, "Klaus Dinger and Michael Rother distilled krautrock to its rhythmic essence — the steady four-on-the-floor 'motorik' beat Dinger devised became one of the most influential drum patterns in rock history. 'Hallogallo' rides that beat for ten minutes of pure forward motion. VERIFY / rewrite.")] },
  ...
  { id: 'wire', name: 'Wire', layer: 'post-punk', genres: ['post-punk'], scope: V1, country: 'UK', activeFrom: 1976, signatureSong: 'Three Girl Rhumba',
    classicAlbums: [ca('pink-flag', 'Pink Flag', 1977, "Twenty-one songs in thirty-five minutes, most of them stripped to a single riff or idea and cut off before they can repeat themselves — art-school minimalism disguised as a punk record. 'Three Girl Rhumba' later resurfaced, note for note, as Elastica's 'Connection.' VERIFY / rewrite.")] },
  { id: 'the-birthday-party', name: 'The Birthday Party', layer: 'post-punk', genres: ['post-punk', 'goth'], scope: V1, country: 'AU', activeFrom: 1976, signatureSong: 'Release the Bats',
    classicAlbums: [ca('junkyard', 'Junkyard', 1982, "A feral, blues-damaged racket built around Rowland S. Howard's serrated slide guitar and a young Nick Cave's unhinged howl, more chaotic and more violent than anything the goth scene it partly spawned would attempt. 'Release the Bats' turned camp horror-movie imagery into a genuine art-punk anthem. VERIFY / rewrite.")] },
  { id: 'fontaines-dc', name: 'Fontaines D.C.', layer: 'post-punk', genres: ['post-punk', 'indie-rock'], scope: V1, country: 'IE', activeFrom: 2017, signatureSong: 'Boys in the Better Land',
    classicAlbums: [ca('dogrel', 'Dogrel', 2019, "Grian Chatten's Dublin-accented sprechgesang rides taut, driving post-punk arrangements steeped in Irish literary tradition as much as Joy Division. 'Boys in the Better Land' turns a taxi-driver's rant into a snarling, propulsive statement. VERIFY / rewrite.")] },
  { id: 'idles', name: 'IDLES', layer: 'post-punk', genres: ['post-punk'], scope: V1, country: 'UK', activeFrom: 2009, signatureSong: 'Danny Nedelko',
    classicAlbums: [ca('joy-as-act-of-resistance', 'Joy as an Act of Resistance', 2018, "Joe Talbot's bellowed, confrontational sincerity over Bristol post-punk's blunt-force riffing turned political anger and vulnerability into an anthemic, cathartic live show. 'Danny Nedelko' is a pro-immigration singalong built on a battering-ram riff. VERIFY / rewrite.")] },
  ...
  { id: 'built-to-spill', name: 'Built to Spill', layer: 'indie-alt', genres: ['indie-rock', 'alt-rock'], scope: V1, country: 'US', activeFrom: 1992, signatureSong: 'Car',
    classicAlbums: [ca('perfect-from-now-on', 'Perfect from Now On', 1997, "Doug Martsch stretched indie-rock song structures into long, guitar-forward suites, layering multiple lead lines over patient, unhurried arrangements. 'Car' rides a single guitar figure for six minutes without ever feeling static. VERIFY / rewrite.")] },
  { id: 'modest-mouse', name: 'Modest Mouse', layer: 'indie-alt', genres: ['indie-rock', 'alt-rock'], scope: V1, country: 'US', activeFrom: 1992, signatureSong: 'Float On',
    classicAlbums: [ca('good-news', 'Good News for People Who Love Bad News', 2004, "Isaac Brock's jittery, philosophical yelp found its widest audience on a record that balanced the band's angular, off-kilter tendencies with genuine pop hooks. 'Float On' turned free-floating anxiety into an unlikely singalong. VERIFY / rewrite.")] },
  { id: 'blur', name: 'Blur', layer: 'indie-alt', genres: ['alt-rock', 'indie-rock'], scope: V1, country: 'UK', activeFrom: 1988, signatureSong: 'Girls & Boys',
    classicAlbums: [ca('parklife', 'Parklife', 1994, "Damon Albarn's sharply observed vignettes of English life, set to music that ranged from music-hall pastiche to synth-driven dance-pop, made Blur the defining band of the Britpop mainstream. 'Girls & Boys' turned package-holiday hedonism into a synth-disco hit. VERIFY / rewrite.")] },
  { id: 'stereolab', name: 'Stereolab', layer: 'indie-alt', genres: ['art-rock', 'indie-rock'], scope: V1, country: 'UK', activeFrom: 1990, signatureSong: 'Metronomic Underground',
    classicAlbums: [ca('emperor-tomato-ketchup', 'Emperor Tomato Ketchup', 1996, "Laetitia Sadier's cool, Marxist-inflected vocals rode motorik krautrock rhythms and analog synth drones, filtered through a Great Society jingle's worth of easy-listening pop. 'Metronomic Underground' loops a single bassline into a hypnotic, nearly six-minute groove. VERIFY / rewrite.")] },
  { id: 'fugazi', name: 'Fugazi', layer: 'indie-alt', genres: ['post-hardcore'], scope: V1, country: 'US', activeFrom: 1986, signatureSong: 'Waiting Room',
    classicAlbums: [ca('13-songs', '13 Songs', 1989, "Compiling Fugazi's first two EPs, this collection distilled Ian MacKaye and Guy Picciotto's dual-vocal, dub-inflected post-hardcore into a manifesto for the genre's next decade. 'Waiting Room' built an entire song from a single skeletal bassline before the guitars detonate. VERIFY / rewrite.")] },
  { id: 'minor-threat', name: 'Minor Threat', layer: 'indie-alt', genres: ['post-hardcore'], scope: V1, country: 'US', activeFrom: 1980, signatureSong: 'Straight Edge',
    classicAlbums: [ca('minor-threat-ep', 'Minor Threat', 1981, "Ian MacKaye's brief, blunt hardcore songs set the template for the entire DC scene and, inadvertently, for a whole straight-edge subculture. 'Straight Edge' runs forty-six seconds and coined the movement's name in the process. VERIFY / rewrite.")] },
