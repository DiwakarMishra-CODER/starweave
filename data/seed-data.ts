...
const artists: Artist[] = [
  // ── Roots (foundational) ────────────────────────────────────
  { id: 'velvet-underground', name: 'The Velvet Underground', layer: 'root', genres: ['art-rock', 'proto-punk'], scope: V1, country: 'US', activeFrom: 1965,
  ...
  { id: 'nico', name: 'Nico', layer: 'root', genres: ['art-rock', 'dream-pop'], scope: V1, country: 'DE', activeFrom: 1967,
  ...
  { id: 'television', name: 'Television', layer: 'root', genres: ['art-rock', 'proto-punk'], scope: V1, country: 'US', activeFrom: 1973,
  ...
  { id: 'talking-heads', name: 'Talking Heads', layer: 'root', genres: ['art-rock', 'post-punk'], scope: V1, country: 'US', activeFrom: 1975,
  ...
  { id: 'big-star', name: 'Big Star', layer: 'root', genres: ['power-pop', 'jangle-pop'], scope: V1, country: 'US', activeFrom: 1971,
  ...
  { id: 'joy-division', name: 'Joy Division', layer: 'post-punk', genres: ['post-punk'], scope: V1, country: 'UK', activeFrom: 1976,
  ...
  { id: 'new-order', name: 'New Order', layer: 'post-punk', genres: ['post-punk', 'dance-punk'], scope: V1, country: 'UK', activeFrom: 1980,
  ...
  { id: 'the-cure', name: 'The Cure', layer: 'post-punk', genres: ['post-punk', 'goth'], scope: V1, country: 'UK', activeFrom: 1978,
  ...
  { id: 'siouxsie-and-the-banshees', name: 'Siouxsie & The Banshees', layer: 'post-punk', genres: ['post-punk', 'goth'], scope: V1, country: 'UK', activeFrom: 1976,
  ...
  { id: 'the-smiths', name: 'The Smiths', layer: 'post-punk', genres: ['jangle-pop', 'indie-rock'], scope: V1, country: 'UK', activeFrom: 1982,
  ...
  { id: 'gang-of-four', name: 'Gang of Four', layer: 'post-punk', genres: ['post-punk', 'dance-punk'], scope: V1, country: 'UK', activeFrom: 1976,
  ...
  { id: 'nick-cave-and-the-bad-seeds', name: 'Nick Cave & The Bad Seeds', layer: 'post-punk', genres: ['post-punk', 'art-rock'], scope: V1, country: 'AU', activeFrom: 1983,
  ...
  { id: 'the-jesus-and-mary-chain', name: 'The Jesus and Mary Chain', layer: 'shoegaze-dreampop', genres: ['shoegaze', 'noise-rock'], scope: V1, country: 'UK', activeFrom: 1983,
  ...
  { id: 'cocteau-twins', name: 'Cocteau Twins', layer: 'shoegaze-dreampop', genres: ['dream-pop', 'shoegaze'], scope: V1, country: 'UK', activeFrom: 1979,
  ...
  { id: 'this-mortal-coil', name: 'This Mortal Coil', layer: 'shoegaze-dreampop', genres: ['dream-pop'], scope: V1, country: 'UK', activeFrom: 1983,
  ...
  { id: 'julee-cruise', name: 'Julee Cruise', layer: 'shoegaze-dreampop', genres: ['dream-pop'], scope: V1, country: 'US', activeFrom: 1989,
  ...
  { id: 'the-sundays', name: 'The Sundays', layer: 'shoegaze-dreampop', genres: ['jangle-pop', 'dream-pop'], scope: V1, country: 'UK', activeFrom: 1987,
  ...
  { id: 'mazzy-star', name: 'Mazzy Star', layer: 'shoegaze-dreampop', genres: ['dream-pop'], scope: V1, country: 'US', activeFrom: 1988,
  ...
  { id: 'my-bloody-valentine', name: 'My Bloody Valentine', layer: 'shoegaze-dreampop', genres: ['shoegaze'], scope: V1, country: 'IE', activeFrom: 1983,
  ...
  { id: 'slowdive', name: 'Slowdive', layer: 'shoegaze-dreampop', genres: ['shoegaze', 'dream-pop'], scope: V1, country: 'UK', activeFrom: 1989,
  ...
  { id: 'ride', name: 'Ride', layer: 'shoegaze-dreampop', genres: ['shoegaze'], scope: V1, country: 'UK', activeFrom: 1988,
  ...
  { id: 'lush', name: 'Lush', layer: 'shoegaze-dreampop', genres: ['shoegaze', 'dream-pop'], scope: V1, country: 'UK', activeFrom: 1987,
  ...
  { id: 'broadcast', name: 'Broadcast', layer: 'shoegaze-dreampop', genres: ['dream-pop', 'art-rock'], scope: V1, country: 'UK', activeFrom: 1995,
  ...
  { id: 'beach-house', name: 'Beach House', layer: 'shoegaze-dreampop', genres: ['dream-pop'], scope: V1, country: 'US', activeFrom: 2004,
  ...
  { id: 'deerhunter', name: 'Deerhunter', layer: 'shoegaze-dreampop', genres: ['shoegaze', 'indie-rock'], scope: V1, country: 'US', activeFrom: 2001,
  ...
  { id: 'alvvays', name: 'Alvvays', layer: 'shoegaze-dreampop', genres: ['jangle-pop', 'dream-pop'], scope: V1, country: 'CA', activeFrom: 2011,
  ...
  { id: 'wolf-alice', name: 'Wolf Alice', layer: 'shoegaze-dreampop', genres: ['shoegaze', 'alt-rock'], scope: V1, country: 'UK', activeFrom: 2010,
  ...
  { id: 'silversun-pickups', name: 'Silversun Pickups', layer: 'shoegaze-dreampop', genres: ['shoegaze', 'alt-rock'], scope: V1, country: 'US', activeFrom: 2000,
  ...
  { id: 'fishmans', name: 'Fishmans', layer: 'shoegaze-dreampop', genres: ['dream-pop'], scope: V1, country: 'JP', activeFrom: 1987,
  ...
  { id: 'sweet-trip', name: 'Sweet Trip', layer: 'shoegaze-dreampop', genres: ['shoegaze', 'dream-pop'], scope: V1, country: 'US', activeFrom: 1998,
  ...
  { id: 'parannoul', name: 'Parannoul', layer: 'shoegaze-dreampop', genres: ['shoegaze'], scope: V1, country: 'KR', activeFrom: 2017,
  ...
  { id: 'pixies', name: 'Pixies', layer: 'indie-alt', genres: ['alt-rock', 'noise-rock'], scope: V1, country: 'US', activeFrom: 1986,
  ...
  { id: 'sonic-youth', name: 'Sonic Youth', layer: 'indie-alt', genres: ['noise-rock', 'alt-rock'], scope: V1, country: 'US', activeFrom: 1981,
  ...
  { id: 'dinosaur-jr', name: 'Dinosaur Jr.', layer: 'indie-alt', genres: ['alt-rock', 'noise-rock'], scope: V1, country: 'US', activeFrom: 1984,
  ...
  { id: 'husker-du', name: 'Hüsker Dü', layer: 'indie-alt', genres: ['alt-rock'], scope: V1, country: 'US', activeFrom: 1979,
  ...
  { id: 'the-replacements', name: 'The Replacements', layer: 'indie-alt', genres: ['alt-rock', 'power-pop'], scope: V1, country: 'US', activeFrom: 1979,
  ...
  { id: 'pavement', name: 'Pavement', layer: 'indie-alt', genres: ['indie-rock', 'alt-rock'], scope: V1, country: 'US', activeFrom: 1989,
  ...
  { id: 'yo-la-tengo', name: 'Yo La Tengo', layer: 'indie-alt', genres: ['indie-rock', 'noise-rock'], scope: V1, country: 'US', activeFrom: 1984,
  ...
  { id: 'rem', name: 'R.E.M.', layer: 'indie-alt', genres: ['jangle-pop', 'alt-rock'], scope: V1, country: 'US', activeFrom: 1980,
  ...
  { id: 'radiohead', name: 'Radiohead', layer: 'indie-alt', genres: ['alt-rock', 'art-rock'], scope: V1, country: 'UK', activeFrom: 1985,
  ...
  { id: 'the-stone-roses', name: 'The Stone Roses', layer: 'indie-alt', genres: ['jangle-pop', 'indie-rock'], scope: V1, country: 'UK', activeFrom: 1983,
  ...
  { id: 'interpol', name: 'Interpol', layer: 'indie-alt', genres: ['post-punk', 'indie-rock'], scope: V1, country: 'US', activeFrom: 1997,
  ...
  { id: 'the-strokes', name: 'The Strokes', layer: 'indie-alt', genres: ['indie-rock', 'alt-rock'], scope: V1, country: 'US', activeFrom: 1998,
  ...
  { id: 'yeah-yeah-yeahs', name: 'Yeah Yeah Yeahs', layer: 'indie-alt', genres: ['indie-rock', 'dance-punk'], scope: V1, country: 'US', activeFrom: 2000,
  ...
  { id: 'geese', name: 'Geese', layer: 'indie-alt', genres: ['art-rock', 'indie-rock'], scope: V1, country: 'US', activeFrom: 2017,
  ...
  { id: 'david-bowie', name: 'David Bowie', layer: 'outside', genres: ['art-rock'], scope: V1, country: 'UK', activeFrom: 1969,
